...
namespace AlinSpace.Development.Configuration
{
    ...
    public class Configuration
    {
        ...
        //        configuration.PathToSolutionFile = PathHelper.MakeRoot(configuration.PathToSolutionFile);
        //        configuration.PathToLocalNugetFolder = PathHelper.MakeRoot(configuration.PathToLocalNugetFolder);
        ...
        //{
        //    var jsonData = JsonSerializer.Serialize(this, new JsonSerializerOptions()
        //    {
        //        WriteIndented = true,
        //    });
